...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected InventoryResult preOpenInventory(ItemsPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ItemsPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, ItemsPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ItemsPlugin plugin, Player player) {
	}
