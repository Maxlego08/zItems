...
import fr.maxlego08.items.zcore.utils.commands.Tab;
...
public abstract class VCommand extends Arguments {
     ...
     */
    public VCommand(ItemsPlugin plugin) {
        super();
        this.plugin = plugin;
    }
     ...
     */
    public CommandType prePerform(ItemsPlugin plugin, CommandSender commandSender, String[] args) {
     ...
     * @return the command type.
     */
    protected abstract CommandType perform(ItemsPlugin plugin);
     ...
     */
    public List<String> toTab(ItemsPlugin plugin, CommandSender sender, String[] args) {
