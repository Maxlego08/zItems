...
import fr.traqueur.items.effects.pipeline.entries.blocks.CropsEntrySettings;
 ...
 * materials. Reuses the same "mature plant" check as {@link fr.traqueur.items.effects.farming.FarmingHoe}
