package fr.traqueur.items.effects.pipeline.entries.durability;
...
@AutoEntry("ITEM_DAMAGE")
public class ItemDamageEntry implements EntryHandler<EmptyEntrySettings> {

    @Override
    public boolean test(EffectContext context, EmptyEntrySettings settings) {
        return context.event() instanceof PlayerItemDamageEvent;
    }
}
